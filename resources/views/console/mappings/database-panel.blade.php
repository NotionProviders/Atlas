<div class="canonical-peek mapping-row-peek">
    <header class="canonical-peek-header canonical-peek-header-minimal">
    ...
    <div class="canonical-peek-body">
        @include('console.mappings.partials.database-details', ['peekMode' => true])
    </div>
</div>
