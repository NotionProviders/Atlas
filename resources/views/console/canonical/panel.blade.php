<div class="canonical-peek">
    <header class="canonical-peek-header">
        ...
        <h2 class="canonical-peek-title" id="canonical-peek-title">{{ $canonicalDatabase->name }}</h2>
        <button type="button" class="canonical-peek-close" data-canonical-close aria-label="Close details">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
